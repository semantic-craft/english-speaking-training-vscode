...
export const MATERIALS_GUIDE_MD = [
  ...
  "",
  "Asset paths in `manifest.json` may be absolute paths or relative paths inside",
  "the package folder. If a relative path escapes the package folder, the sidebar",
  "ignores it and falls back to the default path above.",
  "",
  ...
  "",
"Paste that prompt into Qwen, Gemini, MiMo, or any other capable model.",
